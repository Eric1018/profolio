...
const Header = () => {
  return (
    <div className=' w-11/12 max-w-5xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-6 px-8'>
      <motion.div
      initial={{scale:0}}
      whileInView={{scale:1}}
    ...
    <div className='flex flex-col sm:flex-row items-center gap-4 mt-8'>
        ...
        >Contact Me<Image src="/789.jpg" alt="" width={200} height={200} className='w-4'/></motion.a>
        ...
        >My Resume<Image src="/download.png" alt="" width={200} height={200} className='w-4'/></motion.a>
    </div>
    </div>
  )
}
